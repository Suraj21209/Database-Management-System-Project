...
try:
    cnx = mysql.connector.connect(user='root', password='Suraj$123',port=3306, host='127.0.0.1',database='retailstore',
...
app.config['MYSQL_PASSWORD'] = 'Suraj$123'  # replace with your MySQL password
